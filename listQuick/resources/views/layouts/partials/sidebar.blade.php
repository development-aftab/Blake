    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="side-menu">
                ...
                <li>
                    <a class="waves-effect" href="javascript:void(0);" aria-expanded="false">
                        <i class="glyphicon glyphicon-home fa-fw"></i><span class="hide-menu">Leads <b><span class="badge badge-success"><i class="fa fa-dollar"></i></span></b></span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li @if(Request::is('buySaleProperty/buy-sale-property') && Session::get('request_type')=='pending') {{ "class='active lead_type'" }} @endif class="lead_type">
                            <a style="cursor: pointer;" id="pending_leads" attr="pending"> Pending</a>
                        </li>
                        <li @if(Request::is('buySaleProperty/buy-sale-property') && Session::get('request_type')=='accepted') {{ "class='active lead_type'" }} @endif class="lead_type">
                            <a style="cursor: pointer;" id="accepted_leads" attr="accepted"> Accepted</a>
                        </li>
                        <li @if(Request::is('buySaleProperty/buy-sale-property') && Session::get('request_type')=='rejected') {{ "class='active lead_type'" }} @endif class="lead_type">
                            <a style="cursor: pointer;" id="rejected_leads" attr="rejected"> Rejected</a>
                        </li>
                        <li @if(Request::is('buySaleProperty/buy-sale-property') && Session::get('request_type')=='completed') {{ "class='active lead_type'" }} @endif class="lead_type">
                            <a style="cursor: pointer;" id="completed_leads"  attr="completed"> Completed</a>
                        </li>
 ...
 -->
                    ...
                    <li class="account_setting">
                        @if(Auth::user()->popover_disabled==0)
                            <div class="popover fade right in account-setting-popover" role="tooltip" id="popover118319" style="top: 70px;left: 0px;display: block;background-color: #34343a;color: #ffffff">
                                <div class="arrow" style="top: -7%;transform: rotate(90deg);left: 30%;"></div>
                                <h3 class="popover-title" style="background-color: #34343a;color:#ffffff"><b>Welcome to ListQuick! <b><i style="float:right;margin-top:8px;color:red;cursor:pointer" class="fa fa-trash fa-lg disable_account_setting_popover" data-toggle="tooltip" data-placement="bottom" title="Disable Permanently"></i>
                                        </b></b>
                                </h3>
...
<script type="text/javascript">
    ...
    $('.lead_type').click(function(e){
        e.preventDefault();
        $.ajax({
            url: "{{ route('lead_type') }}/"+$(this).attr('attr'),
            type: "GET",
            cache: false,
            success: function(result){
                window.location.href = "{{ url('buySaleProperty/buy-sale-property') }}"
