                ...
                <div class="white-box">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            @foreach($faq as $item)
                                <tr>
                                    <td>{{ $loop->iteration??$item->id??"Not Available" }}</td>
                                    <td>{{ $item->getTypeName->name??"Not Available" }}</td>
                                    <td>{{ $item->shortTitle??"Not Available" }}</td>
                                    <td>{{ $item->shortDescription??"Not Available" }}</td>
