...
@push('css')
    <style>
        ...
        .red-box {
            ...
            border: 10px solid #EC1C24 !important; ;
        }
        ...
        .black-box {
            ...
            border: 10px solid #2b2a2a !important;
        }
    ...
    @else
        <!-- <div class="container-fluid">
         ...
         <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12">
                    <h1 align="center">ListQuick Dashboard</h1>
                </div>            
            </div>
           <!--  <div class="row">
                <div class="col-md-4 col-sm-6 info-box">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="info-text font-12">Total Booking Requests</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 info-box">
                    <div class="media">
                        <div class="media-left">
                            <span class="icoleaf bg-primary text-white"><i class="mdi mdi-gauge"></i></span>
                        </div>
                        <div class="media-body">
                            <h3 class="info-count text-blue">2</h3>
                            <p class="info-text font-12">Total Yachts</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 info-box">
                    <div class="media">
                        <div class="media-left">
                            <span class="icoleaf bg-primary text-white"><i class="mdi mdi-calendar-check"></i></span>
                        </div>
                        <div class="media-body">
                            <h3 class="info-count text-blue">3</h3>
                            <p class="info-text font-12">Total Special Offers Requests</p>
                        </div>
                    </div>
                </div>
            </div> -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="white-box color-box" style="border: 10px solid black;">
                        <h1 class="font-light" style="color:#000;">${{ $earnings??'' }} <span class="font-14"> {{ $earnerName }} Earnings</span></h1>
                    </div>
                </div>
                <a href="{{url('buySaleProperty/buy-sale-property')}}">
                    <div class="col-md-4 col-sm-12">
                        <div class="white-box color-box red-box">
                            <h1 class="text-white font-light">{{ $requestcount??'' }} <span class="font-14"> Total Property Requests</span></h1>
                        </div>
                    </div>
                </a>
                <a href="{{ url('users') }}">
                    <div class="col-md-4 col-sm-12">
                        <div class="white-box color-box black-box">
                            <h1 class="text-white font-light">{{ $agentscount??'' }} <span class="font-14"> Total Agents</span></h1>
                            <!-- <div class="ct-revenue chart-pos"></div> -->
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="white-box user-table">
                        <div class="row">
                            <div class="col-sm-6">
                                {{--<h4 class="box-title"> Latest Property Requests </h4>--}}
                                <h4 class="box-title"> Referrals </h4>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="myTablePropertyRequest" class="table table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
...
{{--                                        {{var_dump(trim($value->state) != trim(Auth::user()->profile->state))}}--}}
{{--                                        @if(trim($value->state) != trim(Auth::user()->profile->state) && trim(Auth::user()->name) != 'Admin' && trim(Auth::user()->name) != 'ListQuick' )@continue @endif--}}
{{--                                        @if(trim(Auth::user()->name) != 'Admin' && trim(Auth::user()->name) != 'ListQuick' )@continue @endif--}}
                                        <tr>
                                            <td>
                                                {{++$key}}
                                            </td>
                                            ...
                                            <td>
                                                @if($value->request_type == 'sale') Seller @else Buyer  @endif
                                            </td>
                                            <td>
                                                @if($value->location)
                                                    {{ preg_replace('/[0-9]+/', '', strstr( $value->location, ',', true)??"Not available") }}
                                                @else
                                                    {{ preg_replace('/[0-9]+/', '', strstr( $value->location, ',', true)??"Not available") }}
                                                @endif
                                            </td>
                ...
                <div class="col-md-6">
                    <div class="white-box user-table">
                        <div class="row">
                            <div class="col-sm-6">
                                <h4 class="box-title">Latest Agents </h4>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                       @foreach($agents  as $key => $agent)
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                {{ $agent->profile->state??"Not Available"}}
                                            </td>
                                        </tr>
                                      @endforeach
                                 </tbody>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <iframe style="border: 0" id="MainPopupIframe" src="{{url('forums')}}" height="400px" width="100%" title="Iframe Example"></iframe>
                </div>
            </div>
            <br>
         </div>
...
@push('js')
    ...
    <script>
        ...
        var dataTable = $('#myTablePropertyRequest').dataTable(
                {
                    'aoColumnDefs': [{
                        'bSortable': false,
                        'aTargets': [-1] /* 1st one, start by the right */
