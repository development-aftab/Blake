            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    @can('add-'.str_slug('Review'))
                        <a class="btn btn-success pull-right" href="{{ url('/review/review/create') }}"><i
                        ...
                        <table class="table" id="myTable">
                            ...
                            @foreach($review as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->getReviewedByName->name??"Not Available" }}</td>
                                    <td>{{ $item->getReviewedToName->name??"Not Available" }}</td>
                                    <td>{{ $item->revieweer_name??"Not Available" }}</td>
                                    ...
                                    <td>
                                        ...
                                        @can('delete-'.str_slug('Review'))
                                            <form method="POST"
                                                  action="{{ url('/review/review' . '/' . $item->id) }}"
